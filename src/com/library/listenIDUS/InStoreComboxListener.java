 ...
 *2017-5-13
 */
public class InStoreComboxListener implements ActionListener{
	 Instore store;
     
     public InStoreComboxListener(Instore store){
    	 this.store=store;
     }
	/* (non-Javadoc)
	...
	public void actionPerformed(ActionEvent e) {
		...
		String library=store.getComboBox().getSelectedItem().toString();
